...
Public Sub Get_Transition_Array_Tidy_Data_Row_Test()
    ...
    Transition_Array = Load_Tidy_Data.Get_Transition_Array_Tidy(TidyDataFiles:=TidyDataRowFiles, _
                                                                ...
                                                                StartingRowNum:=2, _
                                                                StartingColumnNum:=1)
    Assert.AreEqual Utilities.StringArrayLen(Transition_Array), 7
...
Public Sub Get_Transition_Array_Tidy_Data_Column_Test()
    ...
    Assert.AreEqual Utilities.StringArrayLen(Transition_Array), 8
TestExit:
    Exit Sub
TestFail:
    Assert.Fail "Test raised an error: #" & Err.Number & " - " & Err.Description
...
Public Sub Get_Sample_Array_Tidy_Data_Row_Test()
    ...
    Assert.AreEqual Utilities.StringArrayLen(Sample_Name_Array_from_Tidy_Data), 7
    Assert.AreEqual Utilities.StringArrayLen(MS_File_Array), 7
