...
|                                                                                           |                                                                                         |
|-------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| Load Agilent MRM data in csv file using the button **Load Transition_Name from Raw Data** | Load tabular data in csv file using the button **Load Transition_Name from Table Data** |
| ![Load Transition_Name from Raw Data](figures/trial.gif)                                  | ![Load Transition_Name from Table Data](figures/trial2.gif)                             |
|-------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
